...
with open("./models/Project/BF3 Bots 0.0.4/Level/MP_Subway/data.npy", "rb") as f:
    with open('./models/Project/BF3 Bots 0.0.4/Level/XP1_002/df.npy', 'rb') as fx:
    ...
    with open('./models/Project/BF3 Bots 0.0.4/Level/XP1_002/costs.npy', 'rb') as fx:
        costs_arr = numpy.power(numpy.load(fx)[0], 2)
    with open('./models/Project/BF3 Bots 0.0.4/Level/XP1_002/feature.npy', 'rb') as fx:
